...
from unit_of_work.linker.agid_name_lookup.agid_name_lookup_impl import AgidNameLookupImpl, RemagError
...
class TestAgidNameLookupImpl:
    ...
    @patch('unit_of_work.linker.agid_name_lookup.agid_name_lookup_impl.logger')
